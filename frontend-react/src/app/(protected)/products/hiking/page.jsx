...
export default function ProductHiking() {
  return (
    <>
      ...
      <section className="product-detail-section">
        <div className="container product-grid">
          <div className="product-image-container">
            <img src="/images/hiking.png" alt="boots" />
          </div>
          <div className="product-info-order">
            <h1 className="product-name">Trail Blazer Hiking Boots</h1>
            <p className="product-price">Rs 16999.99</p>
      ...
      <section className="bottom-sections">
        <div className="container bottom-grid">
          <div className="description-box" style={{ animationDelay: '0.2s' }}>
            ...
            <p>Conquer any terrain with these rugged brown leather hiking boots. Designed for durability and comfort, they feature sturdy construction, reinforced eyelets, and vibrant yellow laces for a bold contrast. Whether you're hitting the trails or navigating urban adventures, these boots deliver reliable support and a timeless outdoor look.</p>
          </div>
          <div className="disclaimers-box" style={{ animationDelay: '0.4s' }}>
            ...
            <p><strong>Color:</strong>Vintage Brown with Yellow Laces</p>
            <p><strong>Delivery:</strong> Free delivery within Nepal. International shipping rates may apply.</p>
            <p><strong>Design:</strong>Lace-up hiking boots with padded collar and heavy-duty sole for enhanced grip and comfort.</p>
          </div>
        </div>
      </section>
