        ...
        <section className="product-detail-section">
            <div className="container product-grid">
                ...
                <div className="product-info-order">
                    <h1 className="product-name">Sneakers</h1>
                    <p className="product-price">Rs 8999.99</p>
        ...
        <section className="bottom-sections">
            <div className="container bottom-grid">
                <div className="description-box" style={{animationDelay: '0.2s'}}>
                    ...
                    <p>Step into clean style with these classic all-white casual sneakers — the ultimate blend of simplicity and comfort. Designed for everyday wear, these sneakers feature a sleek low-top silhouette and a soft cushioned sole that keeps your feet supported all day long.</p>
                </div>
                <div className="disclaimers-box" style={{animationDelay: '0.4s'}}>
                    ...
                    <p><strong>Design:</strong> Lace-up closure with padded insole for extra comfort</p>
                </div>
            </div>
        </section>
...
export default ProductSneakers;
