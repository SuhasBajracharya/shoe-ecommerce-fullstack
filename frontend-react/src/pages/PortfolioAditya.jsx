...
This hands-on project helped me deepen my understanding of real-world attack vectors and reinforced the importance of proactive security measures in protecting organizational assets.</p>
                ...
                <div className="project-card">
                    ...
                    <div className="project-content">
                        ...
                        <div className="project-tech">
                            <span className="tech-tag">OWASP ZAP
                ...
                <div className="project-card">
                    <div className="project-img">📊</div>
                    <div className="project-content">
                        <h3 className="project-title">Cryptography Implementation</h3>
                        <p className="project-desc">Implemented various cryptographic algorithms such as AES, RSA, and SHA-256 in Python to understand encryption, decryption, and hashing processes. Tested the strength of these algorithms against common attack vectors and demonstrated the importance of secure key management in safeguarding sensitive data.</p>
                        <div className="project-tech">
        ...
        <div className="container">
            ...
            <div className="contact-content">
                ...
                <div className="contact-info">
                    ...
                    <div className="contact-item">
                        <h3>💼 LinkedIn</h3>
                        <p>linkedin.com/in/TechyAdi</p>
                    </div>
                    <div className="contact-item">
                        <h3>💻 GitHub</h3>
                        <p>github.com/adi007</p>
                    </div>
                    <div className="contact-item">
                        <h3>📱 Phone</h3>
                        <p>+977-9812252573</p>
